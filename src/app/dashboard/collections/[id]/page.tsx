    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button
            variant="outline"
            className="rounded-full px-4 py-2 text-sm border-gray-300 text-gray-700 hover:bg-gray-50"
          >
      ...
      {qnaItems.length === 0 ? (
        ...
        <div className="space-y-4">
          {qnaItems.map((item) => (
            <Card
              key={item.id}
              className="bg-white/70 backdrop-blur-md border-0 shadow-sm hover:shadow-md transition-all duration-200 rounded-2xl"
            >
              <CardHeader>
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex gap-2">
                    <Link
                      href={`/dashboard/collections/${collection.id}/qna/${item.id}/edit`}
                    >
                      <Button
                        variant="outline"
                        className="rounded-full px-3 py-1 text-xs border-gray-300 text-gray-700 hover:bg-gray-50"
                      >

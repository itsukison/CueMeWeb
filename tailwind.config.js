  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'accent-lime': '#D8F9B8',       // Main Accent (Lime Green)
        'accent-light': '#EAFBDD',      // Light Accent / Tint
        'text-primary': '#2B2D2D',      // Primary Text & Icon Color
        'subtle-bg': '#F3F7EF',         // Subtle Lime Gray
